...
def get_review_data(csv_file):
    ...
    data = genfromtxt(csv_file, dtype=None, names=REVIEW_NAMES, \
...
def get_business_data(csv_file):
    ...
    data = genfromtxt(csv_file, dtype=None, names=BUSINESS_NAMES, \
                             delimiter='\t', skip_header=1, comments=None, \
                             filling_values=filling)
...
def get_filtered_business_data(business_data, filtered_value_set):
    return get_filtered_data(review_data, BUSINESS_BUSID_IDX, filtered_value_set)
